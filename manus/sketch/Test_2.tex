...
%     \item Helle Sørensen
%     \item Henrik Holm
%     \item Henrik Laurberg Pedersen
%     \item Henrik Schlichtkrull
%     \item Ian Kiming
%     \item Jan Philip Solovej
%     \item Jesper Grodal
%     \item Jesper Lutzen
%     \item Lars Hesselhot
%     \item Magdalena Musat
%     \item Mikael Rørdam
%     \item Matthias Christandl
%     \item Morten Risager
%     \item Nathalie Wahl
%     \item Niels Martin Møller
%     \item Pieter Spaas
%     \item Susanne Ditlevsen
%     \item Steffen Lauritzen
%     \item Søren Eilers
%     \item Søren Galatius
%     \item Tinne Hoff Kjeldsen
% \end{itemize}
\sings{S1}[Bro] Jeg har Jan Philip, Niels Richard, Niels Martin, Ernst Hansen
...
\sings{S1}[Omkvæd] Han skriver på den, han skriver på den 
Han skriver på den

\sings{S1}[Vers 1] Yeehaw, Uh yeah, ah yeah, se hvor han ka' ja
...
\sings{S1}[Bro] Det Magdalena, Elisenda, Susanne, og Helle, og Britta, \\
...
\sings{S1}[Omkvæd] Hun skriver på den, hun skriver på den
Hun skriver på den

\sings{S1}[Vers 2] Yeehaw, uh yeah, ah yeah, se hvor hun ka' ja
...
\sings{S1}[Bro] Jeg har Matthias, og Ian, og Pieter, og Henrik, og Henrik, 
