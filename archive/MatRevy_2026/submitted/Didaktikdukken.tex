...
\scene{S1-3 er meget hyped}

\says{S2} Daaaamn!!! Der blev du didaktikeret!

\scene{G forstår ikke helt hvad der sker og bliver lidt genert. G tager langsomt sin telefon frem og begynder at scrolle}

\says{S1}[falder lidt til ro] Okay, okay

\says{S3} Hvad skal vi mere lære den?

\scene{S1 og S3 går lidt til siden og kigger i manualen. S2 prøver uden held at få kontakt til G}
